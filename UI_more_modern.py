...
class ModernDesgin(ctk.CTk):
    def __init__(self):
        ...
        self.fraction = ctk.StringVar(value="")
        self.weight = ctk.StringVar(value="")
    ...
    def ui (self):
        ...
        self.label01.grid(row=0, column=0, padx=10, pady=10, sticky="w")
        ...
        self.entry = ctk.CTkEntry(self, textvariable=self.vars["name"], corner_radius=10, width=270,height=45,font=font)
        ...
        self.label02 = ctk.CTkLabel(self, text="Volume", fg_color="black", text_color="white", corner_radius=10,
                                    width=200,height=45,font=font)
        self.label02.grid(row=0, column=2, padx=10, pady=10, sticky="e")
        ...
        # 变量赋值 Volume
        self.enty1 = ctk.CTkEntry(self, textvariable=self.volume,width=200,height=45)
        self.enty1.grid(row=0, column=3, padx=10, pady=10, sticky="e")
        # 设置键位
        ...
        self.label03 = ctk.CTkLabel(self, text="Fraction Wine", fg_color="black", text_color="white", corner_radius=10,
                                    width=200,height=45,font=font)
        self.label03.grid(row=2, column=0, padx=10, pady=10, sticky="w")
        ...
        # 赋值给Fraction Wine
        self.entry2 = ctk.CTkEntry(self, textvariable=self.fraction,width=270,height=45)
        ...
        self.label04 = ctk.CTkLabel(self, text="Weight", fg_color="black", text_color="white", corner_radius=10,
                                    width=200, height=45,font=font)
        self.label04.grid(row=2, column=2, padx=10, pady=10, sticky="e")
        ...
        #赋值给weight
        self.entry3 = ctk.CTkEntry(self, textvariable=self.weight,width=200, height=45)
        self.entry3.grid(row=2, column=3, padx=10, pady=10, sticky="e")
        ...
        # 插入一个空标签作为“空格占位”
        self.spacer = ctk.CTkLabel(self, text="", width=1000)  # 宽度可以自己调整
        self.spacer.grid(row=6, column=0, columnspan=5, padx=10, pady=10, sticky="ew")

        # 用来显示计算结果
        self.label15 = ctk.CTkLabel(self,text = "Blood alcohol content" , fg_color="black", text_color="white", corner_radius=10,width=200, height=45,font=font )
        self.label15.grid(row = 7 , column=0, padx=10, pady=10, sticky="ew")
        self.label15 = ctk.CTkLabel(self, textvariable=self.BAC, fg_color="black", text_color="white",
                                    corner_radius=10, width=300, height=45)
        self.label15.grid(row=7, column=1, columnspan=3, padx=10, pady=10, sticky="ew")
        ...
        self.label06.grid(row=8, column=0, padx=10, pady=10, sticky="w")
        self.label10 = ctk.CTkLabel(self,  textvariable=self.symptoms_var, fg_color="black", text_color="white", corner_radius=10,width=300, height=45 )
        self.label10.grid(row=8, column=1, columnspan=3, padx=10, pady=10, sticky="ew")
        ...
        self.label07.grid(row=9, column=0, padx=10, pady=10, sticky="w")
        ...
        self.label11.grid(row=9, column=1, columnspan=3, padx=10, pady=10, sticky="ew")
        ...
        self.label08.grid(row=10, column=0, padx=10, pady=10, sticky="ew")
        ...
        self.label12.grid(row=10, column=1,columnspan = 3, padx=10, pady=10, sticky="ew")
       ...
       # self.button_1.grid(row=15, column=1, columnspan=2, padx=10, pady=20, sticky="ew")
        ...
        #self.tree.gd(row=9, column=0, columnspan=2, padx=10, pady=10, sticky="ew")
